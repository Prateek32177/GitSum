...
const html = `<div style="border-radius: 0.5rem; border: 1px solid #e5e7eb; background-color: #f9fafb; color: #374151; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); width: 100%; max-width: 48rem;">
